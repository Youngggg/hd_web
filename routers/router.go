...
import (
	"hd_web/controllers"
	"hd_web/controllers/api"
	"hd_web/controllers/page"
...
func init() {
	...
	ns := beego.NewNamespace("/admin",
		...
		beego.NSNamespace("/page",
			...
			beego.NSRouter("/goods-list", &page.AdminPageController{}, "get:GoodsList"),
			beego.NSRouter("/goods-add", &page.AdminPageController{}, "get:GoodsAdd"),
		...
		beego.NSNamespace("/api",
			...
			beego.NSRouter("/goods", &api.GoodsAPIController{}, "get:GoodsList"),
			beego.NSRouter("/goods", &api.GoodsAPIController{}, "put:UpdateGoods"),
			beego.NSRouter("/goods", &api.GoodsAPIController{}, "post:AddGoods"),
			beego.NSRouter("/goods/:id", &api.GoodsAPIController{}, "get:GoodsGet"),
			beego.NSRouter("/goods/disable/:id", &api.GoodsAPIController{}, "get:DisableGoods"),
			beego.NSRouter("/goods/enable/:id", &api.GoodsAPIController{}, "get:EnableGoods"),
			beego.NSRouter("/goods/delete", &api.GoodsAPIController{}, "delete,post:DeleteGoods"),
